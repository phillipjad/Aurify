 ...
 *
 * It also retires outstanding toasts on arrival in the covers section. A
 * generation can finish while the user is on their way there, and a toast
 * pointing at a cover already on screen is noise.
 */
export function CoverGenerationWatcher() {
  ...
  useEffect(() => {
    if (pathname.startsWith('/covers')) dismissCoverToasts()
  }, [pathname])
