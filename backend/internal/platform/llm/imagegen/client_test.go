...
func TestRendersAnImage(t *testing.T) {
	...
	client := New(server.URL, "acct-1", "@cf/bytedance/stable-diffusion-xl-lightning", "tok")
	...
	if want := "/accounts/acct-1/ai/run/@cf/bytedance/stable-diffusion-xl-lightning"; *path != want {
...
func TestDefaultBaseURLBuildsTheRealEndpoint(t *testing.T) {
	got := New("", "acct-1", "@cf/bytedance/stable-diffusion-xl-lightning", "tok").endpoint()
	want := "https://api.cloudflare.com/client/v4/accounts/acct-1/ai/run/@cf/bytedance/stable-diffusion-xl-lightning"
	if got != want {
