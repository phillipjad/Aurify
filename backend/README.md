...
- Prompt and image generation are built; each falls back to a placeholder when
  unconfigured (see [`docs/environment-variables.md`](../docs/environment-variables.md)).
